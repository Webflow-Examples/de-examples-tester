...
export const Components = {
  ...
  componentManagement: {
    ...
    getComponentByName: {
      displayName: 'Get component by name',
      code: async () => {
    ...
    getComponentByNameAndGroup: {
      displayName: 'Get component by name and group',
      code: async () => {
    ...
    getCurrentComponent: {
      displayName: 'Get current component',
      code: async () => {
    ...
    getInstanceCount: {
      displayName: 'Get instance count',
      code: async () => {
    ...
    createComponentWithoutRoot: {
      displayName: 'Create component without root',
      code: async () => {
    ...
    createComponentFromElement: {
      displayName: 'Create component from element',
      code: async () => {
  ...
  componentCanvas: {
    openComponentCanvas: {
      displayName: 'Open component canvas',
      code: async () => {
  ...
  componentInstances: {
    createComponentInstance: {
      displayName: 'Create component instance',
      code: async () => {
        // Get Selected Element
        const selectedElement = await webflow.getSelectedElement()
  ...
  variants: {
    ...
    setVariantSettings: {
      displayName: 'Set variant settings',
      code: async () => {
        const component = await webflow.getCurrentComponent()
  ...
  props: {
    ...
    getInstanceProps: {
      displayName: 'Get instance props',
      code: async () => {
    ...
    getResolvedProps: {
      displayName: 'Get resolved props',
      code: async () => {
        // Get the selected component instance
        const instanceEl = await webflow.getSelectedElement();
    ...
    searchPropsByValueType: {
      displayName: 'Search props by value type',
      code: async () => {
        // Get the selected element and confirm it's a component instance
        const selected = await webflow.getSelectedElement()
