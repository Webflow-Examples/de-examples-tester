...
export const Elements = {
  ...
  elementManagement: {
    ...
    setSelectedElement: {
      displayName: 'Set selected element',
      code: async () => {
    ...
    getParentComponent: {
      displayName: 'Get parent component',
      code: async () => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
  ...
  elementCreation: {
    ...
    BulkAddElementsNavMenu: {
      displayName: 'Bulk add elements nav menu',
      code: async () => {
    ...
    BulkAddElementSVG: {
      displayName: 'Bulk add element SVG',
      code: async () => {
        // Get the selected element as the container
        const selectedElement = await webflow.getSelectedElement()
    ...
    insertElementBefore: {
      displayName: 'Insert element before',
      code: async () => {
        // Get Selected Element
        const selectedElement = await webflow.getSelectedElement()
    ...
    insertElementAfter: {
      displayName: 'Insert element after',
      code: async () => {
        // Get Selected Element
        const selectedElement = await webflow.getSelectedElement()
  ...
  attributes: {
    ...
    getResolvedAttributes: {
      displayName: 'Get resolved attributes',
      code: async () => {
        const element = await webflow.getSelectedElement()
    ...
    getResolvedAttributeValue: {
      displayName: 'Get resolved attribute value',
      code: async () => {
        const element = await webflow.getSelectedElement()
  ...
  styles: {
    ...
    createAndSetStyle: {
      displayName: 'Create and set style',
      code: async () => {
        // Get Selected Element
        const selectedElement = await webflow.getSelectedElement()
  ...
  domOperations: {
    ...
    setAttribute: {
      displayName: 'Set attribute',
      code: async (name: string, value: string) => {
        // Get All Elements and find first DOM Element
        const elements = await webflow.getAllElements()
        const DOMElement = elements.find((element) => element.type === 'DOM')
  ...
  headingOperations: {
    ...
    setHeadingLevel: {
      displayName: 'Set heading level',
      code: async (level: 2 | 1 | 3 | 4 | 5 | 6) => {
        const selectedElement = await webflow.getSelectedElement()
  ...
  // Link Operations
  linkOperations: {
    setLinkBlockSettings: {
      displayName: 'Set link block settings',
      code: async (mode: 'url' | 'page' | 'pageSection' | 'email' | 'phone' | 'file', target: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
  ...
  formOperations: {
    ...
    createFormWithTextarea: {
      displayName: 'Create form with textarea',
      code: async () => {
  ...
  formInputOperations: {
    ...
    setIsRequired: {
      displayName: 'Set is required',
      code: async (required: boolean) => {
        const selectedElement = await webflow.getSelectedElement()
    ...
    createSelectWithCustomDOM: {
      displayName: 'Create select with custom DOM',
      code: async () => {
        const selectedElement = await webflow.getSelectedElement()
  ...
  bindableSources: {
    searchBindableSources: {
      displayName: 'Search bindable sources',
      code: async () => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    searchBindableSourcesBySettingKey: {
      displayName: 'Search bindable sources by setting key',
      code: async (settingKey: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    searchBindableSourcesByValueType: {
      displayName: 'Search bindable sources by value type',
      code: async (valueType: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    searchBindableSourcesWithBothFilters: {
      displayName: 'Search bindable sources with both filters',
      code: async (
        settingKey: string,
        valueType: string,
      ) => {
  ...
  elementSettings: {
    ...
    searchSettingsByKey: {
      displayName: 'Search settings by key',
      code: async (key: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    searchSettingsByValueType: {
      displayName: 'Search settings by value type',
      code: async (valueType: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    searchSettingsWithBothFilters: {
      displayName: 'Search settings with both filters',
      code: async (key: string, valueType: string) => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
    ...
    getResolvedSettings: {
      displayName: 'Get resolved settings',
      code: async () => {
        // Get Selected Element
        const element = await webflow.getSelectedElement()
  ...
  slots: {
    ...
    getDisplayName: {
      displayName: 'Get slot display name',
      code: async () => {
        const componentInstance = await webflow.getSelectedElement()
